  ...
  return (
    <div className="flex h-full flex-col">
      <div className={cn('flex h-16 items-center gap-2 px-4', collapsed && 'justify-center px-2')}>
        ...
        {!collapsed && <span className="truncate text-sm font-bold text-foreground">{APP_NAME}</span>}
      </div>
                ...
                {visibleItems.map((item) => {
                  const link = (
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        cn(
                          'focus-ring group flex items-center gap-2.5 rounded-lg px-2.5 py-2 text-sm font-medium transition-colors',
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="focus-ring flex h-11 items-center justify-center gap-2 border-t border-border text-sm text-muted-foreground hover:bg-muted hover:text-foreground"
